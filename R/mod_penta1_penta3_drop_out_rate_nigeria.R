...
mod_penta1_penta3_drop_out_rate_nigeria_ui <- function(id){
  ...
  tagList(
    ...
    div(class = "col-6 col-6-t measles-col",
        ...
        HTML("<h6 class = 'column-title'>Chart 5: Penta 1, Penta 3 coverage & drop out rate</h6>"),
...
mod_penta1_penta3_drop_out_rate_nigeria_server <- function(id,
  ...
  moduleServer( id, function(input, output, session){
    ...
    chart_data <- reactive({
      ...
      dplyr::tbl(connection, "penta1_penta3_dropout_rate") %>%
    ...
    indicator_plot <- reactive({
      ...
      plotM12Dropout <- plotM12Dropout %>% add_trace(x = ~Months,
                                                     ...
                                                     name = 'Penta 1 Penta 3 Dropout rate',
                                                     color = I("#edb952"),
