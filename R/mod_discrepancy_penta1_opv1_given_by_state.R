#' discrepancy_penta1_opv1_given_by_state UI Function
#'
...
mod_discrepancy_penta1_opv1_given_by_state_ui <- function(id){
  ns <- NS(id)
  tagList(
    ...
    div(class = "col-6 col-6-t measles-col",
        ...
        HTML("<h6 class = 'column-title'> Chart 4: Co-administered antigen discrepancy: Penta 1 & OPV 1 given </h6>"),
...
#' discrepancy_penta1_opv1_given_by_state Server Functions
#'
#' @noRd
mod_discrepancy_penta1_opv1_given_by_state_server <- function(id,
                                                              picker_year_var,
                                                              picker_month_var,
                                                              picker_state_var,
                                                              picker_lga_var){
  ...
  moduleServer( id, function(input, output, session){
    ...
    chart_data <- reactive({
      ...
      dplyr::tbl(connection, "penta1_opv1_discrepancy")%>%
