...
mod_penta_coverage_diphtheria_confirmed_cases_ui <- function(id){
  ...
  tagList(
    ...
    div(class = "col-6 col-6-t measles-col",
        ...
        HTML("<h6 class = 'column-title'>Chart 1: Confirmed diphtheria cases and Penta 1 coverage</h6>"),
...
mod_penta_coverage_diphtheria_confirmed_cases_server <- function(id,
  ...
  moduleServer( id, function(input, output, session){
    ...
    chart_data <- reactive({
      ...
      dplyr::tbl(connection, "diphtheria_alt_denominator")%>%
    ...
    output$downloadData <- downloadHandler(
      ...
      filename = function() {
        paste0("Chart 1- Penta",  picker_state_var(), picker_lga_var(),".csv")
      },
