...
mod_map_confirmed_meningitis_cases_coverage_annual_data_ui <- function(id){
  ...
  tagList(
    ...
    div(class = "col-12 col-12-t yf-col map_col",
        ...
        screenshotButton(id = ns("mvcMap"), filename = "Chart 5- Confirmed meningitis cases and coverage", download =T, scale = 2, label = "", class = "download-data-btn download-chart-btn"),
