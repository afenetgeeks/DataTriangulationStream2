...
app_server <- function( input, output, session ) {
  ...
  #                                                         )
  #
  # measles_inputs_maps <- mod_map_inputs_server("map_inputs_1")
  #
  # mod_map_confirmed_measles_cases_mcv1_coverage_annual_data_server("map_confirmed_measles_cases_mcv1_coverage_annual_data_1",
  #                                                                  picker_year_var = reactive({measles_inputs_maps$picker_year_var}),
  #                                                                  picker_state_var = reactive({measles_inputs_maps$picker_state_var})
  #                                                                  )
  #
  # yf_inputs_maps <- mod_map_inputs_server("map_inputs_2")
  #
  ...
  #                                                                               picker_year_var = reactive({yf_inputs_maps$picker_year_var}),
  #                                                                               picker_state_var = reactive({yf_inputs_maps$picker_state_var})
  #                                                                               )
}
