...
mod_age_group_of_confirmed_yellow_fever_cases_by_vaccination_status_ui <- function(id){
  ...
  tagList(
    ...
    div(class = "col-6 col-6-t yf-col",
        ...
        screenshotButton(id = ns("plot"), filename = "Chart 2 Age group of confirmed Yellow Fever cases by vaccination status", download =T, scale = 2, label = "", class = "download-data-btn download-chart-btn"),
